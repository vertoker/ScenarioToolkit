...
{
    [ScenarioMeta("Добавляет/заменяет переменную в ЛОКАЛЬНОМ контексте")]
    public struct VariableInsert : IScenarioActionContext
    {
        ...
        public IScenarioActionContextData GetRequestData()
            => new VariableInsertContext { Source = this };
    }
    
    public struct VariableInsertContext : IScenarioActionContextData
    {
        public VariableInsert Source;
